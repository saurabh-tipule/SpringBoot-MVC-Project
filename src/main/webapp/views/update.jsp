							...
							<div class="row register-form">
								<div class="col-md-6">
								    ...
								    <div class="form-group">
										<input type="hidden" name="rollno" class="form-control"
											placeholder="First Name *" value="<%= student.getRollno() %>" />
									</div>
									...
									<div class="form-group">
										<input type="text" name="userName" class="form-control"
											placeholder="Username *" value="<%=student.getUserName() %>" />
									</div>

									<div class="form-group">
										<input type="email" name="emailId" class="form-control"
											placeholder="Your Email *" value="<%=student.getEmailId() %>" />
									</div>
									...
									<div class="form-group">
										<input type="text" minlength="10" maxlength="10"
											...
											placeholder="Your Phone No" value="<%=student.getMobileNo() %>" />
									</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<input type="text" name="password" class="form-control"
											placeholder="Password *" value="<%=student.getPassword() %>" />
									</div>
